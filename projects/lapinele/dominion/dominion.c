...
void minionEffect(int choice1,int choice2, struct gameState* state,int handPos)
{
...
void mineEffect(int choice1,int choice2, struct gameState* state,int handPos)
{
